...
typedef uint32 elf32_off;   // unsigned 4-byte integer
typedef uint16 elf32_half;  // unsigned 2-byte integer
typedef uint32 elf32_word;  // unsigned 4-byte integer
typedef int32  elf32_sword; // signed 4-byte integer
typedef uint8  elf32_byte;  // unsigned byte
